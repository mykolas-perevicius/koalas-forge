...
## ⚡ NEW: v1.5.0 - Quality of Life Update (Latest)

**🩺 Auto-Update Checking! Doctor Command! Cleanup Tools!**
...
**👉 [Quick Start Guide](QUICKSTART.md)** | **[Full CLI Reference](CLI_GUIDE.md)**
